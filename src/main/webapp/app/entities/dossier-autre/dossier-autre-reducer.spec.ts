...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOSSIERAUTRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOSSIERAUTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOSSIERAUTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOSSIERAUTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOSSIERAUTRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOSSIERAUTRE actions', async () => {
      const expectedActions = [
        {
