...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPRESENTANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPRESENTANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPRESENTANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPRESENTANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPRESENTANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPRESENTANT actions', async () => {
      const expectedActions = [
        {
