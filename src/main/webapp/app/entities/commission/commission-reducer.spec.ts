...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMMISSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMMISSION actions', async () => {
      const expectedActions = [
        {
