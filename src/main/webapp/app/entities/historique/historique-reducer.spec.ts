...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HISTORIQUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_HISTORIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HISTORIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HISTORIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HISTORIQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HISTORIQUE actions', async () => {
      const expectedActions = [
        {
