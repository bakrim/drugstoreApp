...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './local.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOCAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOCAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOCAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOCAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOCAL actions', async () => {
      const expectedActions = [
        {
