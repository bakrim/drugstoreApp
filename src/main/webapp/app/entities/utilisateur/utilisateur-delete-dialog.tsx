...
export const UtilisateurDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="drugStoreApp.utilisateur.delete.question">
        <Translate contentKey="drugStoreApp.utilisateur.delete.question" interpolate={{ id: utilisateurEntity.id }}>
