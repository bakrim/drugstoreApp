...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOSSIERPHARMACIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOSSIERPHARMACIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOSSIERPHARMACIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOSSIERPHARMACIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOSSIERPHARMACIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOSSIERPHARMACIE actions', async () => {
      const expectedActions = [
        {
