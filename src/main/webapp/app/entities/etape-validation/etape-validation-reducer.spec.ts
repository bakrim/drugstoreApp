...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETAPEVALIDATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_ETAPEVALIDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ETAPEVALIDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ETAPEVALIDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ETAPEVALIDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ETAPEVALIDATION actions', async () => {
      const expectedActions = [
        {
