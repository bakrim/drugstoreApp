...
import com.drugstore.app.repository.ZoneRepository;
...
class ZoneResourceIT {
    ...
    public static Zone createEntity(EntityManager em) {
        Zone zone = new Zone().libelle(DEFAULT_LIBELLE);
        return zone;
    }
    ...
    public static Zone createUpdatedEntity(EntityManager em) {
        Zone zone = new Zone().libelle(UPDATED_LIBELLE);
        return zone;
    }
    ...
    void putExistingZone() throws Exception {
        ...
        updatedZone.libelle(UPDATED_LIBELLE);
