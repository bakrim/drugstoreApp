...
import com.drugstore.app.domain.Role;
import com.drugstore.app.repository.RoleRepository;
...
class RoleResourceIT {
    ...
    public static Role createEntity(EntityManager em) {
        Role role = new Role().libelle(DEFAULT_LIBELLE);
        return role;
    }
    ...
    public static Role createUpdatedEntity(EntityManager em) {
        Role role = new Role().libelle(UPDATED_LIBELLE);
        return role;
    }
    ...
    void putExistingRole() throws Exception {
        ...
        updatedRole.libelle(UPDATED_LIBELLE);
    ...
    void fullUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.libelle(UPDATED_LIBELLE);
